...
public class EditorTracker {
            ...
            if(partref instanceof IEditorReference){
            	if(((IEditorReference)partref).getEditor(false) instanceof AbstractTextEditor){
	                ...
	                if (toolkit.isValid()) {
	                	...
	                	if (project != null) {
	                		CodeForestUIPlugin.ui(project, EditorTracker.this, "caret and mouse listeners added @ "+editor.getTitle());
	                	}
    ...
    public synchronized void annotateEditor(IWorkbenchPartReference partref) {
        ...
        if(fileName != null){
        	...
        	file = file.substring(file.lastIndexOf("src"), file.length());
        }
    ...
    private CaretListener caretListener = new CaretListener(){
		...
		public void caretMoved(CaretEvent caretEvent) {
			...
			if (project != null) {
        		CodeForestUIPlugin.ui(project, EditorTracker.this, "[" + file + "]" + " click @ "+line+code);
        	}
	...
	private MouseTrackListener mouseListener = new MouseTrackListener(){
		...
		public void mouseHover(MouseEvent mouseEvent) {
			try{
				...
				if (project != null) {
	        		CodeForestUIPlugin.ui(project, EditorTracker.this, "[" + file +"] [mouse hover] @ "+line+code);
	        	}
